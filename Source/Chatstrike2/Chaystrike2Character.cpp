...
void AChatstrike2Character::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
        ...
        Cast<UEnhancedInputComponent>(PlayerInputComponent))
    {
        ...
        EnhancedInputComponent->BindAction(FireAction, ETriggerEvent::Completed, this, &AChaystrike2Character::StopFire);

        // Reload
        EnhancedInputComponent->BindAction(ReloadAction, ETriggerEvent::Triggered, this, &AChaystrike2Character::Reload);
        ...
        // Crouch
        EnhancedInputComponent->BindAction(CrouchAction, ETriggerEvent::Started, this, &AChaystrike2Character::StartCrouch);
        EnhancedInputComponent->BindAction(CrouchAction, ETriggerEvent::Completed, this, &AChaystrike2Character::StopCrouch);

        // Sprint
        EnhancedInputComponent->BindAction(SprintAction, ETriggerEvent::Started, this, &AChaystrike2Character::StartSprint);
        EnhancedInputComponent->BindAction(SprintAction, ETriggerEvent::Completed, this, &AChaystrike2Character::StopSprint);

        UE_LOG(LogTemp, Warning, TEXT("Input setup complete!"));
    }
}

void AChaystrike2Character::Move(const FInputActionValue& Value)
{
...
void AChaystrike2Character::TakeDamage(float Damage, AActor* DamageCauser)
{
    ...
    UE_LOG(LogTemp, Warning, TEXT("Health: %.1f, Armor: %.1f"), Health, Armor);
...
void AChaystrike2Character::Heal(float HealAmount)
{
    ...
    UE_LOG(LogTemp, Warning, TEXT("Healed! Health: %.1f"), Health);
}
